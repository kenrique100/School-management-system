...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <br>
            <form action="displaystaffUpdate.php" method="post">
                    ...
                    <select name="staff" id="" class="form-control" required>
                        ...
                        if ($result->num_rows > 0){
                            while ($row = $result->fetch_assoc()){
                                ?>
                                <option value="<?php print $row['staff_ID'];?>"><?php print $row['staff_ID'];?></option>
                                <?php
                            }
                        }
                        mysqli_close($conn);
               ...
               <div class="buttons">
                   ...
                   &nbsp;&nbsp;
                   <a class="btn btn-dark" href="staff.php">Cancel Search</a>
               </div>
